...
class ProcessingSoftwaresController extends Controller
{
    ...
    public function softwareReport(){
        $softwaresAndBrandsRecords = FileReplySoftwareService::leftjoin('file_services', 'file_services.file_id', '=', 'file_reply_software_service.file_id')->distinct('file_reply_software_service.file_id')->get();

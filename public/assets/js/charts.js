    ...
    $(document).ready(function () {
        ...
        (function () {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [
                    {
                        data: seriesData[0],
                        color: $.Pages.getColor("success-light", 0.5), // Get Pages contextual color
                        name: "DB Server",
                    },
                    {
                        data: seriesData[1],
            ...
            d3.selectAll("#rickshaw-realtime_y_axis .tick.major line").attr(
                "x2",
                "7"
            );
            d3.selectAll("#rickshaw-realtime_y_axis .tick.major text").attr(
                "x",
                "12"
            );
                ...
                nv.addGraph(function () {
                    var chart = nv.models
                        ...
                        .color([
                            ...
                            $.Pages.getColor("info"),
                            $.Pages.getColor("primary", 0.87), //south america
                            $.Pages.getColor("warning"),
                            $.Pages.getColor("complete", 0.67), //europe
                            $.Pages.getColor("success-dark"),
                            $.Pages.getColor("menu", 0.2), //antarctica
                        ])
                        .margin({
                            left: 15,
                        })
                ...
                nv.addGraph(
                    function () {
                        ...
                        nv.utils.windowResize(function () {
                            ...
                            setTimeout(function () {
                                d3.selectAll(
                                    "#nvd3-line2 .nvd3 circle.nv-point"
                                ).attr("r", "4");
                            }, 300);
                        });
        ...
        var drawSparklineLine = function () {
            ...
            $("#sparkline-line").sparkline([0, 10, 8, 20, 15, 10, 15, 5], {
                ...
                height: "200",
                chartRangeMax: 40,
                fillColor: $.Pages.getColor("danger", 0.3), // Get Pages contextual color
            ...
            $("#sparkline-line").sparkline([10, 10, 25, 29, 20, 22, 20, 22], {
                ...
                width: Math.round(elemWidth),
                height: "200",
                fillColor: $.Pages.getColor("warning", 0.3), // Get Pages contextual color
                lineColor: "rgba(0,0,0,0)",
                highlightLineColor: "rgba(0,0,0,.09)",
                highlightSpotColor: "rgba(0,0,0,.21)",
        ...
        $('#tabs-rickshaw a[data-toggle="tab"]').on(
            "shown.bs.tab",
            function (e) {
                var chart;
        ...
        $('#tabs-nvd3 a[data-toggle="tab"]').on("shown.bs.tab", function (e) {
            ...
            setTimeout(function () {
                d3.selectAll("#nvd3-line2 .nvd3 circle.nv-point").attr(
                    "r",
                    "4"
                );
            }, 300);
        ...
        $('#tabs-sparkline a[data-toggle="tab"]').on(
            "shown.bs.tab",
            function (e) {
                var target = $(e.target).attr("data-target");
                var tabPane = $(target);

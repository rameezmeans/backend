...
Route::get('/refund/{id}', [App\Http\Controllers\PaymentLogController::class, 'refund'])->name('refund');
...
Route::post('/ajax_all_user_files/{user_id}', [App\Http\Controllers\FilesController::class, 'ajaxAllUserFiles'])->name('ajax-all-user-files');
Route::post('/ajax_all_user_rejected_files/{user_id}', [App\Http\Controllers\FilesController::class, 'ajaxAllUsersRejectedFiles'])->name('ajax-all-user-rejected-files');
Route::post('/process_in_davinci', [App\Http\Controllers\FilesController::class, 'processInDavinci'])->name('process-in-davinci');
...
Route::post('sample-messages', [SampleMessagesController::class, 'store'])->name('sample-messages.store');

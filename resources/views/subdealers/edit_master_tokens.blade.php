      ...
      <!-- START CONTAINER FLUID -->
        <div class=" container-fluid container-fixed-lg bg-white">
          ...
          <div class="card card-transparent m-t-40">
            ...
            <div class="card-body">
                <form class="" role="form" method="POST" action="{{route('update-master-tokens')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    @enderror
                      ...
                      <div class="form-group form-group-default required ">
                        ...
                        <input value="@if($skey){{$skey->value}}@endif"  name="stripe_key" type="text" class="form-control" required>
                      </div>
                      @error('stripe_key')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                      ...
                      <div class="form-group form-group-default required ">
                        ...
                        <input value="@if($ssecret){{$ssecret->value}}@endif"  name="stripe_secret" type="text" class="form-control" required>
                      </div>
                      @error('stripe_secret')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>

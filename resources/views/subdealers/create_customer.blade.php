        ...
        <div class=" container-fluid   container-fixed-lg bg-white">
          ...
          <div class="card card-transparent m-t-40">
            ...
            <div class="card-body">
              ...
              <form class="" role="form" method="POST" action="@if(isset($customer)){{route('update-subdealer-customer')}}@else{{ route('add-subdealer-customer') }}@endif" enctype="multipart/form-data">
                @csrf

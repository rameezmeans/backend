        ...
        <div class=" container-fluid   container-fixed-lg bg-white">
          ...
          <div class="card card-transparent m-t-40">
            <div class="card-header ">
                ...
                <div class="col-xs-12">
                    <button data-redirect="{{ route('edit-customer', $user->id) }}" class="btn btn-success btn-cons m-b-10 redirect-click" type="button"><i class="pg-plus_circle"></i> <span class="bold">Customer</span>
                    </button>

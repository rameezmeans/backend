...
.responsive-cards li {
    flex: 0 0 auto; /* keep each card its own width */
}

.social-card {
    width: 175px; /* can shrink on smaller screens if needed */
}

/* Optional: shrink cards on smaller screens */
@media (max-width: 768px) {
    .responsive-cards {
        padding-left: 20px; /* reduce left spacing for tablet */
    }
    .social-card {
        width: 140px;
    }
...
@media (max-width: 480px) {
    .responsive-cards {
        padding-left: 15px; /* almost edge for mobile */
    }
    .social-card {
        width: 100%;
    }

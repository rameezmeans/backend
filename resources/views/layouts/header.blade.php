              ...
              <div class="notification-panel">
                ...
                <div class="notification-body scrollable">
                  <!-- START Notification Item-->
                    ...
                    <!-- START Notification Item-->
                    @foreach($allEngineers as $engineer)
                    <div class="notification-item clearfix @if($loggedInUser->id == $engineer->id) flip-status @endif">
                      <div class="card social-card share col1" data-social="item" style="" data-id="{{$engineer->id}}">
                        <div class="circle" data-toggle="tooltip" title="" data-container="body" data-original-title="Label">
                        </div>
                        <div class="card-header clearfix">
                          <div class="user-pic">

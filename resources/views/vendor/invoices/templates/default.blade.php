                ...
                <tr>
                    <td class="px-0">
                        ...
                        @foreach($invoice->seller->custom_fields as $key => $value)
                            ...
                            @if($key == 'address')
                                <p class="seller-code">
                                    {{ $invoice->seller->code }}, {{ $invoice->seller->city }}, {{ code_to_country( $invoice->seller->country ) }}
                                </p>
                            @elseif($key == 'company')
                                <p class="seller-vat">
                        ...
                        {{-- @if($invoice->seller->code)
                            <p class="seller-code">
                                {{ $invoice->buyer->code }}, {{ $invoice->buyer->city }}, {{ code_to_country( $invoice->buyer->country ) }}
                            </p>
                        @endif --}}

                ...
                <div class="col-lg-4">
                    <div class="form-group form-group-default">
                        ...
                        @foreach($services as $service)
                            <option value="{{$service->service_id}}">{{\App\Models\Service::findOrFail($service->service_id)->name.','}}@if(\App\Models\Service::findOrFail($service->service_id)->active == 1) ECUTech @elseif(\App\Models\Service::findOrFail($service->service_id)->tuningx_active == 1) Tuning-X @endif</option>
                        @endforeach
                        </select>
                    </div>
                </div>

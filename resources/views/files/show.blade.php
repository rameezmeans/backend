                        ...
                        <div class="b-b b-t b-grey p-l-20 p-r-20 p-b-10 p-t-10">
                          ...
                          @endphp
                            ...
                            <div class="p-l-20 p-r-20 p-b-10 p-t-10">
                                ...
                                <div class="label label-success m-l-10">{{ date('H:i:s d/m/Y', strtotime($message['created_at']))}} </div>
                  ...
                  <div class="card-header @if($file->frontend->id == 1) bg-primary-light @else bg-warning-light @endif">
                    ...
                    <div class="text-center">
                      <div class="card-title">
                          ...
                          <h4>{{$file->brand}} {{$file->model}} {{ $file->engine }} {{ $file->vehicle()->TORQUE_standard }}</h4>

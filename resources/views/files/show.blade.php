                    ...
                    <div class="row m-t-40">
                      ...
                      <div class="col-lg-6  m-t-30">
                        ...
                        <div class="b-b b-grey p-l-20 p-r-20 p-b-10 p-t-10">
                          ...
                          <div class="pull-right">
                            <span class="label label-success">{{ date_format(new DateTime($file->assignment_time),"Y/m/d H:i:s") }}<span>
                          </div>
                          <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="b-b b-grey p-l-20 p-r-20 p-b-10 p-t-10">
                          ...
                          <div class="pull-right">
                            <span class="label label-success">{{ date_format(new DateTime($file->reupload_time),"Y/m/d H:i:s") }}<span>
                          </div>
                          <div class="clearfix"></div>
                        </div>
                      ...
                      @if($file->stages)
                        @if(\App\Models\Service::where('name', $file->stages)->first())
                          ...
                          <div class="b-t b-grey p-b-10 p-t-10">
                            ...
                            $totalRows = count($stage->softwares($file->ecu, $file->brand));
                            $tempCount = 1;
                            ...
                            @if($tempCount == $totalRows)
                              <div class="pull-right">
                                {{$stage->revisions($s->software_id, $file->ecu, $file->brand)+1}}
                              </div>
                            @else
                              <div class="pull-right">

          ...
          <div class="card card-transparent m-t-40">
            <div class="card-header ">
                ...
                <div class="pull-right">
                    <div class="col-xs-12">
                        <button data-redirect="{{ route('feedback-emails') }}" class="btn btn-success btn-cons m-b-10 redirect-click" type="button"><i class="pg-plus_circle"></i> <span class="bold">Feedback Emails</span>
                        </button>

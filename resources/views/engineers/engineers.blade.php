        ...
        <div class=" container-fluid   container-fixed-lg bg-white">
          ...
          <div class="card card-transparent m-t-40">
            <div class="card-header ">
                <div class="card-title"><h3>Engineers</h3>
                </div>
                <div class="pull-right">
                <div class="col-xs-12">
                    <button data-redirect="{{route('create-engineer')}}" class="btn btn-success btn-cons m-b-10 redirect-click" type="button"><i class="pg-plus_circle"></i> <span class="bold">Add Engineer</span>
                    </button>
                        ...
                        <table class="table table-hover demo-table-search table-responsive-block dataTable no-footer" id="tableWithSearch" role="grid" aria-describedby="tableWithSearch_info">
                            ...
                            <tbody>
                                @foreach ($engineers as $engineer)
                                    <tr role="row" class="redirect-click" data-redirect="{{ route('edit-engineer', $engineer->id) }}">
